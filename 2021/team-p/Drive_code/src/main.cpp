...
// driveFor(forward, x, inches) does not drive the exact number of inches, the average
// amount to change is to subtract 3.90625
...
// turnFor(right, x, degrees) does not turn for the right number of degrees, to turn 90 degrees,
// you have to enter 70.5 degrees instead, so the change rate is around 0.78333
...
>>>>>>> e7b43e638bb1dd7634ab847389874524e9978801
