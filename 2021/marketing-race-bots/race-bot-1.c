#pragma config(Motor,  port2,           Back_Right,    tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port3,           Back_Left,     tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port4,           Front_Left,    tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port5,           Front_Right,   tmotorVex393_MC29, openLoop, reversed)
