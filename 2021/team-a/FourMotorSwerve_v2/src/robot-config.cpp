...
motor FrontLeftMotor = motor(PORT20, ratio18_1, false);
motor RearLeftMotor = motor(PORT1, ratio18_1, false);
motor_group LeftDriveSmart = motor_group(FrontLeftMotor, RearLeftMotor);
motor FrontRightMotor = motor(PORT4, ratio18_1, true);
motor RearRightMotor = motor(PORT19, ratio18_1, true);
motor_group RightDriveSmart = motor_group(FrontRightMotor, RearRightMotor);
drivetrain Drivetrain = drivetrain(LeftDriveSmart, RightDriveSmart, 319.19,
                                   387.34999999999997, 342.9, mm, 1);
controller Controller1 = controller(primary);
motor LeftLiftMotor = motor(PORT3, ratio36_1, true);
