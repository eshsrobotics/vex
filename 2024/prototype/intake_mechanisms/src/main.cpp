...
void autonomous() {
  ...
  auto D = make_shared<TurnTask>(94.7, gyro);
  ...
  auto I = make_shared<TurnTask>(65.01, gyro);
  ...
  auto M = make_shared<TurnTask>(8.57, gyro);
  ...
  auto Q = make_shared<TurnTask>(prototype, -3.83);
