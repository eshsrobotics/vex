...
//         double elapsedTimeSec = Brain.timer(vex::timeUnits::sec) -
//         startTimeSec;
...
//                     // turnSpeedPct = 0; Commenting out this line would allow
//                     us to drive and turn at the same time. break;

//                 case TURN_CLOCKWISE:
//                     turnSpeedPct = parameter;
//                      // turnSpeedPct = 0; Commenting out this line would
//                      // allow us to drive and turn at the same time.
//                     break;
...
//             // moveArm(armSpeedPct, clawState, armMotorLeft, armMotorRight,
//             clawMotor);
