#ifndef AUTON_TASK_TREE_H_INCLUDED
#define AUTON_TASK_TREE_H_INCLUDED
...
struct TurnTask : public Task {
  ...
  TurnTask(vex::motor_group &motor_group1, vex::motor_group &motor_group2, vex::inertial &inertial, double rotationAmountDegrees);
...
struct IntakeTask : public Task {
  vex::motor intakeMotor;
  int timeSec;
  double intakeSpeedPct;

  IntakeTask(vex::motor &intakeMotor, int timeSec, double intakeSpeedPct);
