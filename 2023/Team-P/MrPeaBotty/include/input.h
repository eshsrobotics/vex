...
void arcade_drive(double horizontalChannel, double verticalChannel, vex::motor_group& left, vex::motor_group& right);
...
const vex::brakeType ROBOT_BRAKE_TYPE = vex::brakeType::hold;